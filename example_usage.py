...
for sample_name, zxy_voxels_mask_arr_path in zip(timesteps, zxy_voxels_mask_arr_paths):
    ...
    # create lbos from point cloud
    smooth_pcd_lbo_creation_args = LBOCreationArgs(num_LBOs=300, is_point_cloud=True, geometry_path=dataset.file_paths.point_cloud_from_mesh_smooth[sample_name], orig_geometry_name="point_cloud_from_mesh_smooth", use_torch=True)
