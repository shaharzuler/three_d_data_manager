...
class Mesh2VoxelsConvertor:
    def __init__(self, mesh_path, original_shape):
        ...
        x_pad_bef, y_pad_bef, z_pad_bef, x_pad_aft, y_pad_aft, z_pad_aft = self._get_padding_values_for_voxels(self.mesh, original_shape, tight_dense_voxels.shape)
        self.padded_voxelized = np.pad(tight_dense_voxels, ((x_pad_bef, x_pad_aft), (y_pad_bef, y_pad_aft), (z_pad_bef, z_pad_aft)))

    @staticmethod
    def _get_padding_values_for_voxels(mesh:pv.PolyData, original_shape:Tuple[int], unpadded_shape:Tuple[int]):
